...
Proof.
  ...
  generalize dependent m.
    ...
    - destruct m as [| m' ] eqn:Hm. (* Automatically intros H1 this time. *)
      + discriminate H1.
      + discriminate H1.
Qed.
  (* FILL IN HERE *)
...
Theorem contrapositive : forall (P Q : Prop),
  (P -> Q) -> (~Q -> ~P).
Proof.
  intros P Q. unfold not. intros H1 H2 H3. apply H2. apply H1. apply H3.
Qed.
  (* FILL IN HERE *)
(** [] *)
...
Proof.
  ...
  - intros H. apply H3. apply H1. apply H.
  - intros H. apply H2. apply H4. apply H.
Qed.
  (* FILL IN HERE *)
(** [] *)
...
Proof.
  ...
  - intros H. destruct H as [H1 | H2]. 
    ...
    + destruct H2 as [H21 H22]. split. right. apply H21. right. apply H22.
  - intros H. destruct H as [H1 H2]. destruct H1 as [H11 | H12].
    + left. apply H11.
...
Proof.
  intros X P H. intros H0. destruct H0 as [x0 H1]. assert (P x0) as H2.
...
Proof.
  intros X P Q. split.
  - intros H. destruct H as [x0 H1]. destruct H1 as [H2 | H3].
      left. exists x0. apply H2.
      right. exists x0. apply H3.
  - intros H. destruct H as [H1 | H2].
      destruct H1 as [x0 H3]. exists x0. left. apply H3.
      destruct H2 as [x1 H4]. exists x1. right. apply H4.
Qed.
   (* FILL IN HERE *)
(** [] *)
...
Proof.
  ...
  - intros. induction l as [|x' l' IHl'].
    ...
    + simpl in H. destruct H as [H1 | H2].
      ...
      { apply IHl' in H2. destruct H2 as [x [H3 H4]]. exists x. split. apply H3. right. apply H4. }
  - intros [x0 [H1 H2]]. induction l as [| x' l' IHl'].
    + simpl in H2. contradiction.
    + destruct H2 as [H3 | H4].
      { rewrite -> H3. rewrite <- H1. left. reflexivity. }
...
Proof.
  intros A l. induction l as [|a0' l0 IHl0].
  - induction l' as [|a1' l1' IHl1 ].
    ...
    + split.
      { intros H. simpl in H. destruct H.
        { right. left. apply H. } 
        { right. right. apply H. } }
      { intros H. simpl in H. destruct H as [H1 |[ H2 | H3]].
        { contradiction. }
        { left. apply H2. }
        { right. apply H3. } }
  - induction l' as [|a1' l1' IHl1].
    + split.
      { intros H. simpl in H. destruct H.
        { left. left. apply H. }
        { left. right. apply IHl0 in H. destruct H.
          { apply H. }
          { simpl in H. contradiction. } } }
      { intros H. simpl in H. destruct H as [[H1 | H2] | H3].
        { left. apply H1. }
        { right. apply IHl0. left. apply H2. }
        { contradiction. } }
    + split.
      { intros H. simpl in H. destruct H.
        { left. left. apply H. }
        { apply IHl0 in H. simpl in H. destruct H as [H1 | [H2 | H3]].
          { left. right. apply H1. }
          { right. left. apply H2. }
      ...
      { intros H. simpl in H. destruct H as [ [H1 | H2] | H3].
        ...
        { destruct H3 as [H4 | H5].
          { right. apply IHl0. right. left. apply H4. }
          { right. apply IHl0. right. right. apply H5. }
        }
      }
Qed.
  (* FILL IN HERE *)
...
Proof.
  ...
  - induction l as [| x' l' IHl'].
    + intros. inversion H0.
    + intros. simpl in H. simpl in H0. destruct H. destruct H0.
      * rewrite <- H0. apply H.
...
Proof.
  intros.
  destruct (odd n) eqn:En.
  - unfold combine_odd_even. rewrite En. apply H. reflexivity.
  - unfold combine_odd_even. rewrite En. apply H0. reflexivity.
Qed.
  (* FILL IN HERE *)
